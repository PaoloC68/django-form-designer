...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('form_designer_formdefinitionfield', 'field_class', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'FormDefinitionField.field_class'
        db.alter_column('form_designer_formdefinitionfield', 'field_class', self.gf('django.db.models.fields.CharField')(max_length=32))
